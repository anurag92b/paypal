        ...
        <>
            ...
            <input type="hidden" name="password" value="<?= $_POST['password']; ?>"> */}
                                ...
                                <div class="important-msg">
                                    ...
                                    <div class="form-group">
                                        <div class="row_form_n">
                                            ...
                                            <div class="col_form_items" id="select_inputfield">
                                                <input type="number" maxLength="10" class="form-control" placeholder="234-567-8910" name="number" id="exampleInputPassword1" required value={contact.no} onChange={e => Setcontact({ ...contact, no: e.target.value })} />
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" id="cointiue_btn" class="btn btn-primary" >Submit</button>
                                    </div>
